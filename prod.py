...
class Product:
    ...
    def _init_(self, name, price, quantity, condition="new", origin_country=""):
    ...
    def _repr_(self):
        ...
        return f"{self.name} ({self._class.name_}) | Price: {self.price} | Qty: {self.quantity}{origin}"
...
class Laptop(Product):
    ...
    def _init_(
        ...
        super()._init_(name, price, quantity, condition, origin_country)
